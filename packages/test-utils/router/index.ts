...
export const routes = [
  ...
  },
  {
    ...
    component: () =>
      import('@/pages/order-platforms/OrderPlatformFormPage.vue'),
    meta: { layout: 'AppLayoutDefault' },
  },
  {
    path: '/contacts',
  ...
  },
  {
    ...
    component: () =>
      import('@/pages/event-categories/EventCategoriesFormPage.vue'),
    meta: { layout: 'AppLayoutDefault' },
  },
  {
    path: '/lessons',
  ...
  },
  {
    ...
    component: () =>
      import('@/pages/purpose-lessons/PurposeLessonFormPage.vue'),
    meta: { layout: 'AppLayoutDefault' },
  },
  {
    path: '/bot-users',
